    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <button onClick={()=> addToCart(productData._id , size) } className="bg-black text-white px-8 py-3 text-sm
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border text-sm text-gray-500 py-6 px-6'>
      ...
      <div className='mt-20 mb-3 text-center text-3xl'>
